      ...
      <tr>
        ...
        {index !== 0 ? (
          <td>
            ...
            >
              <IoTrashOutline style={{ marginTop: -3 }} />
            </button>
          </td>
        ) : (
          ""
      ...
      <div className="card-body p-0">
        ...
        >
          ...
          <div className="text-end p-10 ">
            <div className="btn-group" style={{ marginRight: 15 }}>
              <button
                className="btn btn-lg btn-secondary rounded"
                type="button"
                style={{ width: 80, height: 40, fontSize: 15, marginRight: 20 }}
              >
                Clear
              </button>
              <button
